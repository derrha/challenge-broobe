...
<body class="flex flex-col h-screen w-screen bg-gray-100">
    ...
    <div class="flex flex-col sm:flex-row flex-grow">
        ...
        <div id="metricsResults" class="flex-grow p-6 flex items-center flex-col">
            ...
            <button id="saveMetricsButton" class="hidden mt-4 py-2 px-4 max-h-12 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#503fe0]">Guardar Métricas</button>
        </div>
    </div>
